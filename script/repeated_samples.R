...
cel_cts <- readRDS("C:/Users/UappaSguappa/Desktop/R_Projects/stool/data/ngs/cel_rep.rds")
...
cts <- bind_cols(vov_rep_cts, cel_rep_cts)

saveRDS(cts, file = "data/ngs/repeated_counts.rds")
